...
from .OverallLineEssenceModule import OverallLineEssence as OLineEssence
...
class OverallLineData:
    ...
    def __init__(self,oLineEssence :OLineEssence):
    ...
    # 全体ラインデータファイルの作成
    def _MakeOLineData(self,oLineEssence :OLineEssence):
